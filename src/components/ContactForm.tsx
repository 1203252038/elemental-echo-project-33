...
const ContactForm = () => {
  ...
  return <div className="relative max-w-md mx-auto">
      ...
      <div className="bg-[#F48487] text-white text-center py-4 px-6 rounded-sm shadow-[0_4px_8px_rgba(0,0,0,0.4)] relative z-10 mx-6 mb-2">
        <h3 className="font-sybarite text-xl font-bold">Contact Us</h3>
      </div>
      
      {/* White form card with larger border radius */}
      <div className="bg-white rounded-xl shadow-lg p-8 pt-16 -mt-14">
