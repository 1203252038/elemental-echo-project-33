                    ...
                    <table className="w-full border-collapse">
                      <tbody>
                        <tr className="border-b border-gray-200">
                          <td className="py-4 pr-6 align-top font-neutra text-19px font-medium text-gray-900 w-1/4 min-w-[200px]">
                            Grey Blackwing
                          </td>
                        ...
                        <tr className="border-b border-gray-200">
                          ...
                          <td className="py-4 align-top font-neutra text-19px leading-relaxed text-gray-700">
                            Every Blackwing pencil has this bomb extendable eraser, but the eraser itself isn't great even if it extends with this awesome metal clamp thing, so it makes sense to seek out a separate eraser. I am someone that literally does eraser wars and can blind identify my favorite erasers. I am pleased to announce that my favorite eraser of all time has finally made its way to Amazon. The BOXY eraser will forever hold my heart. Did I know that I was capable of such steadfast devotion to an eraser? No. But BOXY earns its spot with smooth, easy, effective erasing. Also, its motto on the sleeve: "The basic concept of BOXY always aims at a simple life style." So true, BOXY. So true.
                          </td>
                        </tr>
                        <tr className="border-b border-gray-200">
                          <td className="py-4 pr-6 align-top font-neutra text-19px font-medium text-gray-900 w-1/4 min-w-[200px]">
