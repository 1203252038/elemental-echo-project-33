    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="font-sybarite text-50px md:text-92px leading-tight text-navy mb-8 text-center">
          ...
          <div className="prose prose-lg max-w-none text-foreground">
            ...
            <section className="mb-12">
              <h2 className="font-sybarite text-30px text-navy mb-6">Let Me Just Show You</h2>
            ...
            {/* But How? Section */}
            <section className="mb-12">
              <h2 className="font-sybarite text-30px text-navy mb-6">But How?</h2>
              <p className="font-neutra text-19px leading-relaxed mb-6">
            ...
            {/* Who is Ana? Section */}
            <section className="mb-12">
              <h2 className="font-sybarite text-30px text-navy mb-6">Who is Ana?</h2>
              <p className="font-neutra text-19px leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-sybarite text-30px text-navy mb-6">December 16: Translation Debugging</h2>
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">Improvement Takes Praise Too</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">But I Can't Remember… Or Can You?</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-sybarite text-30px text-navy mb-6">January 1: Wordskating</h2>
              <div className="mb-8 bg-gray-100 p-4 rounded-lg">
                <iframe 
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">Gliding Over Those Words Like Ice</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">And Now We Are Watching a Football Game</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-sybarite text-30px text-navy mb-6">January 11: The End of Wordskating</h2>
              <div className="mb-8 bg-gray-100 p-4 rounded-lg">
                <iframe 
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">We Won!</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
                Ten days later, Ana has stopped wordskating 🎉! This is a major victory.
              </p>

              <h3 className="font-sybarite text-20px text-navy mb-4">Now For The Real Work</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-sybarite text-30px text-navy mb-6">January 12: The Turning Point</h2>
              <div className="mb-8 bg-gray-100 p-4 rounded-lg">
                <iframe 
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">We Won (Again!)</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">The Chance to Get Niche</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">One CLIR is Enough</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-sybarite text-30px text-navy mb-6">February 6: She's a Real Natural</h2>
              <div className="mb-8 bg-gray-100 p-4 rounded-lg">
                <iframe 
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">A Little Over Three Weeks Later…</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">We're Ghost Hunters</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">What a Natural Looks Like</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
            ...
            <section className="mb-12">
              <h2 className="font-sybarite text-30px text-navy mb-6">February 8: Now She Has to Realize It</h2>
              <div className="mb-8 bg-gray-100 p-4 rounded-lg">
                <iframe 
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">Perfect Isn't Enough</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
              ...
              <h3 className="font-sybarite text-20px text-navy mb-4">But Perfect Also Isn't Real</h3>
              <p className="font-neutra text-19px leading-relaxed mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-8">
              <Link 
                to="/tutoring"
                className="bg-peach hover:bg-peach-light text-white font-neutra font-medium text-12px uppercase px-8 py-4 rounded-[3px] transition-all duration-300 hover:scale-105 shadow-lg"
              >
                Learn More About Tutoring
              </Link>
              <Link 
                to="/student-stories"
                className="bg-transparent border-2 border-peach text-peach hover:bg-peach hover:text-white font-neutra font-medium text-12px uppercase px-8 py-4 rounded-[3px] transition-all duration-300 hover:scale-105"
              >
